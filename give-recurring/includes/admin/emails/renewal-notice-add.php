	...
	<form id="give-add-renewal-notice" action="" method="post">
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<input name="subject" id="give-notice-subject" class="give-notice-subject" type="text" placeholder="<?php _e('Your Subscription is About to Renew', 'give-recurring') ?>" value="" style="min-width:300px;" />
